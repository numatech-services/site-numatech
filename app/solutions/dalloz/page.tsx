...
export const metadata: Metadata = {
  title: 'Dalloz – Intelligence juridique | Numatech Services',
  description: 'Dalloz : base documentaire juridique complète. Codes, jurisprudence, doctrine, actualités. Pour facultés de droit, IEP et écoles de commerce.',
}
const hero = { title: 'Dalloz', subtitle: 'L\'intelligence juridique au service des professionnels', desc: 'Accédez à la base juridique la plus complète et la plus fiable. Dalloz accompagne les juristes, enseignants et étudiants avec une documentation exhaustive et constamment mise à jour.', color: 'from-slate-700 to-gray-900', tag: 'Documentation juridique' }
const features = ['Codes et textes officiels consolidés', 'Jurisprudence exhaustive commentée', 'Doctrine experte et actuelle', 'Actualités juridiques en temps réel', 'Outils de recherche avancés', 'Module Dalloz Étudiant pédagogique']
const avantages = ['Sécurisation des analyses juridiques', 'Gain de temps dans les recherches', 'Accès structuré et fiable à l\'information', 'Soutien pédagogique renforcé']
const tarifs = [{ nom: 'Forfait Étudiant', prix: 'À partir de 2 500', desc: 'Par an, accès modules essentiels' }, { nom: 'Forfait Institution', prix: 'Sur devis', desc: 'Selon modules et effectifs' }]
