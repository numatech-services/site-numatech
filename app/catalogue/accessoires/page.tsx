...
export const metadata: Metadata = {
  title: 'Accessoires & Périphériques | Catalogue Numatech',
  description: 'Accessoires & Périphériques pour établissements scolaires. Devis gratuit, livraison incluse.',
}

const produits = [
  { nom: 'Pack Clavier+Souris Logitech MK270', prix: 22850, detail: 'Sans fil · 2.4 GHz · Portée 10m · Piles incluses' },
  { nom: 'Casque audio filaire', prix: 10800, detail: 'Jack 3.5mm · Micro intégré · Robuste · Pour 1 poste' },
  { nom: 'Housse tablette 10-11"', prix: 15750, detail: 'Anti-choc · Poignée · Pour iPad et Android' },
]

export default function Page() {
  return (<>
    <Breadcrumbs items={[{ label: 'Catalogue', href: '/catalogue' }, { label: 'Accessoires & Périphériques' }]} />
    <section className="bg-gradient-to-br from-gray-500 to-gray-700 text-white py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-6xl mb-4">🔌</div>
        <h1 className="text-4xl font-bold mb-3">Accessoires & Périphériques</h1>
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 mb-10">
          {produits.map((p, i) => (
            <div key={i} className="bg-neutral-50 rounded-2xl p-6 border-2 border-gray-100 hover:border-gray-400 hover:shadow-xl transition">
